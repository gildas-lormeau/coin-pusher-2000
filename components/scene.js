import { Quaternion, Vector3, Euler, Scene, Color, WebGLRenderer, PCFSoftShadowMap, PMREMGenerator, DirectionalLight, AmbientLight, SRGBColorSpace, ACESFilmicToneMapping } from "three";
...
const DIRECTIONAL_LIGHT_SHADOW_BIAS = -0.;
