...
const BASE_ROTATION_SPEED = Math.PI / 12.5;
const BASE_ROTATION_CLEANUP_SPEED = Math.PI / 9;
const ARM_PROTECTION_LID_SPEED = 0.1;
const BASE_CLEANUP_ROTATIONS = 4;
const COIN_SETTLED_POSITION_Y = 0.13;
const COIN_IMPULSE_FORCE = new Vector3(0, 0, 0.0000006);
...
export default class {
    ...
    constructor({ scene, cabinet, onInitializeCoin, groups }) {
        this.#scene = scene;
    ...
    async initialize() {
        ...
        initializeLights({ lightBulbsMaterials, lights: this.#stacker.lights });
